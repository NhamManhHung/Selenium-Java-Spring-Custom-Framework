...
//		options.addArguments("--headless=new");
	...
	public WebDriver getEdgeDriver() {
        /*
        System.setProperty("wdm.cachePath", System.getProperty("user.home") + "/.cache/selenium");
...
//		options.addArguments("--headless=new");
        ...
        */
        String driverPath = System.getProperty("user.home") + "/.cache/selenium/edgedriver/win64/141.0.3537.57/msedgedriver.exe";
	...
	*/
    ...
    @ConditionalOnExpression("'${my.properties.grid}'.equals('false') and '${my.properties.browser}'.equals('edge')")
    @Scope("driverscope")
    public WebDriverWait getEdgeDriverWait(WebDriver driver) {
        return new WebDriverWait(driver, myProperties.getExplicitTimeout());
    }
}
